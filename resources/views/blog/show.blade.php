                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body" id="comment-list">
                        ...
                        <div class="media mb-3 border-bottom pb-3 replay">
                            <img width="30" height="30" src="{{ avatar($comment->user->avatar) }}" class="mr-3 rounded-pill" alt="...">
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.code == 200) {
                            ...
                            $('#comment-list').append(`
                            <div class="media mb-3 border-bottom pb-3 replay">
                            <img width="30" height="30" src="${ res.data.avatar_url }" class="mr-3 rounded-pill" alt="...">
                            <div class="media-body">
