                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   name="name"
                                   value="{{old('name')}}"
                                   placeholder="请填写用户名" class="form-control form-control-sm" id="exampleInputName" aria-describedby="emailHelp">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="email"
                                   name="email"
                                   value="{{old('email')}}"
                                   placeholder="请填写邮箱" class="form-control form-control-sm" id="exampleInputEmail" aria-describedby="emailHelp">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1" class="fs-14 font-weight-bold">密码</label>
                            <input type="password"
                                   name="password"
                                   placeholder="请填写密码" class="form-control form-control-sm" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword2" class="fs-14 font-weight-bold">重复密码</label>
                            <input type="password"
                                   name="password_confirmation"
                                   placeholder="请填写确认密码" class="form-control form-control-sm" id="exampleInputPassword2">
                        </div>
