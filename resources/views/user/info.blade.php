                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('user.info.update') }}"  class="col-md-6 offset-3">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" type="text" value="{{ auth()->user()->name }}" placeholder="请填写用户名" class="@error('name') is-invalid @enderror form-control form-control-sm" id="exampleInputName" aria-describedby="emailHelp">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input name="email" type="email" value="{{ auth()->user()->email }}" placeholder="请填写邮箱" class="@error('email') is-invalid @enderror form-control form-control-sm" id="exampleInputEmail" aria-describedby="emailHelp">
                                @error('email')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
